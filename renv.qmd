...
![](https://github.com/allisonhorst/stats-illustrations/raw/main/rstats-artwork/data_cowboy.png)

**Develop** -> **Share** -> **Productionize**

::: citation

"Illustrations from Hadley Wickham's talk "The Joy of Functional Programming (for Data Science)." by [Allison Horst](https://github.com/allisonhorst/stats-illustrations)
:::
...
**vetiver**
  -   Vetiver provides fluent tooling to version, deploy, and monitor a trained model. Functions handle both recording and checking the model’s input data prototype, and predicting from a remote API endpoint.
:::
...
::: {layout="[1, 20]"}
![](https://d33wubrfki0l68.cloudfront.net/9f64516ebe93a8e5c91ea7409cbf422f8fec00e9/d75bd/logo.svg){width="50"}
...
## New tools and tricks: Vetiver {.smaller}

![](https://d33wubrfki0l68.cloudfront.net/53bf04d08be52c5780c0ac6ba4083928bdc740a3/55234/blog/announce-vetiver/thumbnail_huc2394eec6c3beee37cf037e067ab5abf_208023_1110x0_resize_q75_box.jpg)
