...
graph LR
    ...
    subgraph CONFIG[Config]
      ...
      SRENVIRON[Renviron.site<br/>etc/Rprofile.site]
      SRRPROFILE[Rprofile.site</br>etc/R.home/Renviron.site]
    ...
    subgraph LIBRARY[Package Library Path]
      ...
      USERLIBRARY[User<br/>R_HOME/library]
...
## Scenario 5: Moving a project from a system with OS centos7 to rockylinux8.9
...
## Scenario 7: Simultaneously working on a project from two different OS

TODO

## Scenario 8: Programmatically migrating renv projects on Workbench from an old OS to a new OS

TODO

## Scenario 9: Recovering an old project that didn't have an renv and isn't working with latest R, package versions 

TODO

## Scenario 10: Going between OS on the same Workbench system using slurm / singularity with a renv project
